...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='job',
            name='currentstep',
            field=models.IntegerField(default=0, db_column=b'currentStep', choices=[(0, 'Unknown'), (1, 'Awaiting decision'), (2, 'Completed successfully'), (3, 'Executing command(s)'), (4, 'Failed')]),
        ),
    ]
